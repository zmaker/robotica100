/**
005 - la percezione è pari alla distanza dal cibo

In questo sketc rileviamo la disanza dalla posizione corrente dell'agente, senza ancora utilizzarla...
*/
...
Percezione scanAmbiente(Agente ag, Food f){  
  float d = dist(ag.getX(), ag.getY(), f.getX(), f.getY());
  Percezione p = new Percezione(d);
  println(d);
  return p;
}
